        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8" data-aos="fade-up">
              <h1 className="display-6 fw-bold mb-3">Help Center</h1>
              <p className="lead mb-4">Search common questions or reach our support team.</p>
              <div className="hero-card shadow-sm p-4 bg-white rounded-3 border">
                <form className="row g-3 text-start">
                  <div className="col-12">
                    <label className="form-label">Search</label>
                    <input type="text" className="form-control form-control-lg" placeholder="e.g. How to schedule a pickup" />
                  </div>
                  <div className="col-12 d-grid d-md-flex gap-3">
                    <button type="button" className="btn btn-primary btn-lg flex-fill">Search</button>
                    <Link to="/contact" className="btn btn-outline-primary btn-lg flex-fill">Contact us</Link>
                  </div>
                </form>
              </div>
            </div>
            ...
            <div className="col-lg-6" data-aos="fade-up">
              <div className="accordion" id="faqLeft">
                <div className="accordion-item">
                  ...
                  <div id="q1" className="accordion-collapse collapse show" aria-labelledby="q1h" data-bs-parent="#faqLeft">
                    <div className="accordion-body">
                      Go to <Link to="/create-shipment">Create Shipment</Link>, fill your details and choose a pickup window.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="q2h">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#q2" aria-expanded="false" aria-controls="q2">
                      Where can I see my shipment status?
                    </button>
                  </h2>
                  <div id="q2" className="accordion-collapse collapse" aria-labelledby="q2h" data-bs-parent="#faqLeft">
                    <div className="accordion-body">
                      Enter your tracking number on the <Link to="/tracking">Tracking</Link> page to see live updates.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              <div className="accordion" id="faqRight">
                <div className="accordion-item">
                  ...
                  <div id="q3" className="accordion-collapse collapse" aria-labelledby="q3h" data-bs-parent="#faqRight">
                    <div className="accordion-body">
                      Yes, add Insurance in Options while creating a shipment. Claims are processed within 5–7 days.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  <div id="q4" className="accordion-collapse collapse" aria-labelledby="q4h" data-bs-parent="#faqRight">
                    <div className="accordion-body">
                      Rates depend on weight, dimensions, distance and service. Use the <Link to="/rates">Rates</Link> page for instant quotes.
                    </div>
                  </div>
                </div>
              </div>
