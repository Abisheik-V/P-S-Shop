...
export default function CreateShipment() {
  ...
  const numbers = useMemo(() => {
    ...
    const subtotal = c.base + weightCost + distanceCost + intl + insuranceFee + fragileFee + codFee
    ...
    return {
      ...
      breakdown: { km, weightCost, distanceCost, intl, insuranceFee, fragileFee, codFee }
    }
  ...
  return (
    <div className="homepage">
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-lg-6" data-aos="fade-up">
              ...
              <p className="lead mb-4">Enter shipment details, schedule pickup, and print your label.</p>
              <div className="d-flex gap-3">
                <Link to="/rates" className="btn btn-outline-primary btn-lg px-4">Check Rates</Link>
                <a href="#shipment-form" className="btn btn-primary btn-lg px-4">Start Now</a>
              </div>
            </div>
            <div className="col-lg-6" data-aos="fade-left">
              <div className="hero-card p-4">
                <div className="small text-muted mb-2">Same-Day • Standard • International</div>
                <div className="d-flex gap-3 flex-wrap">
                  <span className="badge bg-light text-dark px-3 py-2">Door pickup</span>
                  <span className="badge bg-light text-dark px-3 py-2">Live tracking</span>
                  <span className="badge bg-light text-dark px-3 py-2">Insurance</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="shipment-form" className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-4" data-aos="fade-up">
            <h2 className="h1 mb-2">Shipment Details</h2>
            <p className="text-muted">Provide pickup, delivery, and package information.</p>
          </div>
            ...
            <div className="card-body p-4">
              <form className="row g-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="col-12 col-xl-4">
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      ...
                      <input className="form-control" placeholder="e.g. Apparel - T-shirts" value={contents} onChange={(e) => setContents(e.target.value)} />
                    </div>
                    <div className="col-12">
                ...
                <div className="col-12 col-lg-8">
                  <div className="h5 mb-3">Pickup schedule</div>
                  <div className="row g-3">
                    ...
                    <div className="col-sm-12 col-lg-4 d-grid d-lg-block align-self-end">
                      <Link to="/rates" className="btn btn-outline-primary w-100">Estimate Cost</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12 col-lg-4">
                  ...
                  <div className="d-grid gap-2">
                    ...
                    <Link to="/tracking" className="btn btn-outline-primary">Track Shipment</Link>
                  </div>
                  ...
                  {numbers.breakdown && (
                    <div className="mt-2 small text-muted">
                      ...
                      {selectedService === 'International' ? `, intl ₹${numbers.breakdown.intl.toFixed(2)}` : ''}
